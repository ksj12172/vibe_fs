    ...
    const etfData = [
      {
        ...
        nameKor: "뱅가드 토탈 월드 주식 ETF",
        nameEng: "Vanguard Total World Stock ETF",
        market: "ETF",
        exchange: "NYSEARCA",
        sector: null,
        industry: null,
        description:
          "<ul> <li>Invests in both foreign and U.S. stocks.</li> <li>Seeks to track the performance of the FTSE Global All Cap Index, which covers both well-established and still-developing markets.</li> <li>Has high potential for growth, but also high risk; share value may swing up and down more than U.S. or international stock funds.</li> <li>Only appropriate for long-term goals.</li> </ul>",
        website:
